    ...
    if st.sidebar.button("구글 로그인"):
        try:
            ...
            if sign_in_response and hasattr(sign_in_response, "url"):
                ...
                st.sidebar.markdown(
                    f'<a href="{login_url}" target="_self" style="display: inline-block; padding: 10px 20px; background-color: #4285F4; color: white; text-decoration: none; border-radius: 5px; font-weight: bold; text-align: center;">구글 로그인 페이지로 이동</a>',
        ...
        st.sidebar.info("구글 로그인을 위해 버튼을 클릭해주세요.")
